<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="场地地址" prop="changdidizhi">
          <el-input v-model="ruleForm.changdidizhi" 
              placeholder="场地地址" clearable  :readonly="ro.changdidizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="场地地址" prop="changdidizhi">
              <el-input v-model="ruleForm.changdidizhi" 
                placeholder="场地地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.changdixiangqing = this.ruleForm.changdixiangqing.replace(reg,'../../../springbootcd8ka/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
