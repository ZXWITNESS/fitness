    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="教练姓名" prop="jiaolianxingming">
          <el-select :disabled="ro.jiaolianxingming" @change="jiaolianxingmingChange" v-model="ruleForm.jiaolianxingming" placeholder="请选择教练姓名">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="擅长项目" prop="shanzhangxiangmu">
          <el-input v-model="ruleForm.shanzhangxiangmu" 
              placeholder="擅长项目" clearable  :readonly="ro.shanzhangxiangmu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="擅长项目" prop="shanzhangxiangmu">
              <el-input v-model="ruleForm.shanzhangxiangmu" 
...
export default {
  ...
  methods: {
	...
	this.ruleForm.gerenjianjie = this.ruleForm.gerenjianjie.replace(reg,'../../../springbootcd8ka/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
