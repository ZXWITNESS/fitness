  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='jiaolian'">
			...
			<el-form-item label="身份证号" class="input" v-if="tableName=='jiaolian'">
			...
			<el-form-item label="身高" class="input" v-if="tableName=='jiaolian'">
			...
			<el-form-item label="体重" class="input" v-if="tableName=='jiaolian'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(`jiaolian` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){
        this.$message.error(`联系电话应输入手机格式`);
        return
      }
      if(`jiaolian` == this.tableName && this.ruleForm.shenfenzhenghao&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzhenghao))){
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20220204/fe01c25555b94bf4b7b4566556159041.jfif);
