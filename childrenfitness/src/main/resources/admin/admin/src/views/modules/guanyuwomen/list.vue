  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
		...
		<el-form-item class="select" label="教练姓名" prop="jiaolianxingming">
		  <el-select  @change="jiaolianxingmingChange" clearable v-model="searchForm.jiaolianxingming" placeholder="请选择教练姓名">
		    <el-option
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="体重">
		     <template slot-scope="scope">
                ...
                <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign" 
                    prop="shanzhangxiangmu"
                   :header-align="contents.tableAlign"
		    label="擅长项目">
		     <template slot-scope="scope">
                       {{scope.row.shanzhangxiangmu}}
                     </template>
                </el-table-column>
